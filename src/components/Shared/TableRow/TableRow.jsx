...
const TableRow = ({ product }) => {
  // We need setProducts from context to update the list after deletion
...
// const TableRow = ({ product,onDelete  }) => {
...
//             <Edit2 size={16} />
//           </button>
//           <button onClick={handleDelete} className="p-1.5 bg-rose-50 text-rose-600 rounded-lg hover:bg-rose-100">
//             <Trash2 size={16} />
//           </button>
//         </div>
//       </td>
