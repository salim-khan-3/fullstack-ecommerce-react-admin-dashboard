...
const AddCategory = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const dataToSubmit = {
      name: formData.name,
      images: [formData.imageUrl], // এখানে imageUrl কে array-তে রূপান্তর করা হয়েছে
      color: formData.color,
    };

    try {
      const data = await createCategory(dataToSubmit); // এখন dataToSubmit পাঠান
          ...
          <div className="bg-white rounded-[2rem] shadow-2xl shadow-slate-200/50 border border-slate-100 p-8 md:p-10 relative overflow-hidden transition-all">
            <div className="relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Brand Color Accent with Custom Input */}
                <div className="group">
                  <label className="block text-sm font-bold text-slate-700 mb-2 ml-1 group-focus-within:text-indigo-600 transition-colors">
                    Brand Color Accent
                  </label>
                    ...
                    <div className="flex-1 flex items-center px-2">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          // শুধু Valid Hex ক্যারেক্টার এবং লিমিটেড লেন্থ চেক
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-5 px-6 rounded-2xl transition-all duration-300 shadow-xl shadow-indigo-200 hover:shadow-indigo-300 hover:-translate-y-1 active:translate-y-0"
                >
                  <CloudUpload size={22} />
        ...
        <div className="hidden lg:flex lg:col-span-5 xl:col-span-7 items-center justify-center p-12">
          <div className="relative group">
            ...
            <div
              ...
              style={{ backgroundColor: formData.color }} // ব্যাকগ্রাউন্ড আপনার সিলেক্ট করা কালার
            >
              {/* Visual Pattern Overlay (Sparkles) */}
              {/* প্যাটার্নের অপাসিটি কমানো হয়েছে যাতে কালো লেখার সাথে হিজিবিজি না লাগে */}
              ...
              {/* টেক্সট সেকশন - কালার এখন ব্ল্যাক (slate-900) */}
            ...
            {/* Aesthetic Ring */}
            <div className="absolute -inset-6 border-2 border-dashed border-slate-200 rounded-[3.5rem] -z-10 group-hover:rotate-3 transition-transform duration-700 opacity-50"></div>
          </div>
        </div>
      </div>
    </div>
