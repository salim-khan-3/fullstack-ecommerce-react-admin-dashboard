...
import {
  ...
  Twitter, Facebook, Eye, EyeOff, Phone,
} from "lucide-react";

const inputClass = "w-full bg-gray-50 dark:bg-[#374151] border border-gray-100 dark:border-gray-600 rounded-xl py-3.5 pl-12 pr-4 text-sm text-gray-700 dark:text-white outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all";
        ...
        <div className="w-full flex flex-col lg:flex-row bg-[#F8FAFC] transition-colors duration-500">
          <div className="flex-1 flex items-center justify-center min-h-screen py-10">
            <div className="w-full max-w-[480px] px-4">
              <div className="bg-white dark:bg-[#1F2937] p-8 sm:p-10 rounded-[2.5rem] shadow-2xl dark:shadow-none border border-gray-100 dark:border-gray-700">
                ...
                <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-[#0061FF] hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold py-4 rounded-xl shadow-lg shadow-blue-500/20 transition-all active:scale-[0.98] uppercase tracking-wider text-sm"
                  >
