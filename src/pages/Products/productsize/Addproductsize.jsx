...
const AddProductSize = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await axiosInstance.post("/productSize/create", { name });
    ...
    <div className="p-4 font-sans">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-6 py-4 flex flex-col md:flex-row md:items-center justify-between gap-3 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-800">Add Size</h1>
            <p className="text-xs text-gray-400">Add a new product Size option</p>
          </div>
        </div>
        <nav className="flex items-center gap-1.5 text-xs">
          ...
          <ChevronRight size={12} className="text-gray-300" />
          <div className="px-3 py-1.5 rounded-lg bg-blue-600 text-white font-semibold shadow-sm">Add Size</div>
        </nav>
      </div>
      ...
      <div className="max-w-lg">
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-cyan-600 px-6 py-4">
            <h2 className="text-white font-bold text-base">Size Information</h2>
