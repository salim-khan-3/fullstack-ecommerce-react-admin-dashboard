  ...
  return (
    <div className=" bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4 font-sans">
      <form onSubmit={handleSubmit(onSubmit)} className=" mx-auto space-y-6">
        {/* ── Breadcrumb Header ── */}
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-white shadow-sm px-4 sm:px-6 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          {/* Left: Icon + Title */}
