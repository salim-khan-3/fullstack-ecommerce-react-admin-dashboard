            ...
            <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-6 shadow-lg text-white">
              ...
              <div className="space-y-3 mb-5">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-bold text-blue-200 text-xs">{selectedRams.length} selected</span>
                </div>
                <div className="w-full h-px bg-white/10" />
                <div className="flex items-center justify-between text-sm">
                  <span className="text-blue-200">Size</span>
                  <span className="font-bold text-blue-200 text-xs">{selectedSizes.length} selected</span>
                </div>
                <div className="w-full h-px bg-white/10" />
                <div className="flex items-center justify-between text-sm">
                  <span className="text-blue-200">Weight</span>
                  <span className="font-bold text-blue-200 text-xs">{selectedWeights.length} selected</span>
                </div>
                <div className="w-full h-px bg-white/10" />
                <div className="flex items-center justify-between text-sm">
