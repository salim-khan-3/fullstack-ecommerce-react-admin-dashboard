...
import { getUserCount, getProductCount, getOrderCount, getReviewCount } from "../../../api/useApi";
...
export default function StatsCards() {
  ...
  const [stats, setStats] = useState({ users: 0, orders: 0, products: 0, reviews: 0 });
  ...
  if (loading) {
    return (
      <div className="w-full grid grid-cols-2 lg:grid-cols-4 gap-5 mt-4">
        {[...Array(4)].map((_, i) => (
